...
using static StellarChat.Shared.Infrastructure.Observability.Logging.SerilogOptions;
using Microsoft.Extensions.Logging;
using Serilog;
using Serilog.Filters;
using FileOptions = StellarChat.Shared.Infrastructure.Observability.Logging.SerilogOptions.FileOptions;
...
public static class Extensions
{
    ...
    private const string LoggerSectionName = "serilog";
